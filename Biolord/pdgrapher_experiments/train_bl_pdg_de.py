...
if __name__ == "__main__":
    ...
    parser.add_argument('--treated_pickle', type=str,
                        default='/raid/home/public/chemoe_collab_102025/PDGrapher/data/full_downloads/chemical/real_lognorm/chemical_PDGrapher_df_10302025.pkl',
                        help='Path to treated data pickle')
    parser.add_argument('--diseased_pickle', type=str,
                        default='/raid/home/public/chemoe_collab_102025/PDGrapher/data/full_downloads/chemical/real_lognorm/chemical_PDGrapher_diseased_df_10302025.pkl',
