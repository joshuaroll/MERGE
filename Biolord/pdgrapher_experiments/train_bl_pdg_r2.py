...
Usage:
    python train_bl_pdg_r2.py --test_cell A375 --fold 1 --gpu 2 --max_epochs 10
    python run_all_biolord.py --gpu 6 --cells A375 --folds 1 2 3 4 5 --max_epochs 100
"""
...
def compute_persample_metrics(true_vals, pred_vals, gene_indices=None, show_progress=True):
    ...
    # r = sum((x - x_mean)(y - y_mean)) / (n * std_x * std_y)
    ...
    # This is slower, so we sample if too many samples
