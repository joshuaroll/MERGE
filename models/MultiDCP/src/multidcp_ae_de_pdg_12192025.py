#!/usr/bin/env python3
"""
MultiDCP AE training script with Differential Expression (DE) metrics.
...
Usage:
cd /raid/home/joshua/projects/MultiDCP/MultiDCP/
    x python multidcp_ae_de_pdg_12192025.py --test_cell A375 --fold 1 --gpu 0
    python multidcp_ae_de_pdg_12192025.py --test_cell MCF7 --fold 1 --gpu 0
    x python multidcp_ae_de_pdg_12192025.py --test_cell A549 --fold 1 --gpu 1
    python multidcp_ae_de_pdg_12192025.py --test_cell HT29 --fold 1 --gpu 2
    python multidcp_ae_de_pdg_12192025.py --test_cell PC3 --fold 1 --gpu 3
    python multidcp_ae_de_pdg_12192025.py --test_cell VCAP --fold 1 --gpu 4
    python multidcp_ae_de_pdg_12192025.py --test_cell HELA --fold 1 --gpu 5
    python multidcp_ae_de_pdg_12192025.py --test_cell MDAMB231 --fold 1 --gpu 6
    python multidcp_ae_de_pdg_12192025.py --test_cell BT20 --fold 1 --gpu 7
...
import datareader_pdg_12122025 as datareader
import metric
import wandb
import pdb
import pickle
...
from multidcp_ae_pdg_utils import *
...
if __name__ == '__main__':
    ...
    model.to(device)
    # Using float32 for consistency with data utilities (removed .double())
    USE_WANDB = True
    
    wandb_name = f'multidcp_de_{args.test_cell}_fold{args.fold}_sd{args.seed}'
    
    if USE_WANDB:
        wandb.init(project="MultiDCP_AE_DE", config=args, name=wandb_name)
